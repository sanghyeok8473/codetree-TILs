...
public class Main {
    public static void main(String[] args) {
        ...
        if(x1[0] >= x1[1] && x2[0] <= x2[1]){
            if( y1[0] >= y1[1] && y2[0] <= y2[1] ) // 두번째 직사각형이 첫 직사각형을 완전히 덮으면 잔해물이 없으므로 덮을 것도 없음.
                System.out.print(0); 
            else if( y1[0] < y1[1] && y2[0] > y2[1]) // 두번째 직사각형이 직사각형 중간을 깔끔하게 지웠을 때
            ...
            if( x1[0] >= x1[1] && x2[0] <= x2[1] ) // 두번째 직사각형이 첫 직사각형을 완전히 덮으면 잔해물이 없으므로 덮을 것도 없음.
                System.out.print(0);    
            if( x1[0] < x1[1] && x2[0] > x2[1] ) // 두번째 직사각형이 직사각형 중간을 깔끔하게 지웠을 때
                System.out.print(first);
